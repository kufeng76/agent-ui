...
const ActionButton = ({ href, variant, text }: ActionButtonProps) => {
  const baseStyles =
    'px-4 py-2 text-sm transition-colors font-dmmono tracking-tight text-primaryAccent'
  const variantStyles = {
    primary: 'border border-border hover:bg-background-secondary rounded-xl'
  }
